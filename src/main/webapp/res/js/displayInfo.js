...
var ProductImage = {
	...
	animate : function(children, childrenLength, direction) {
		...
		this.setEnableArrowButton(".btn_prev", onPrevProductImageButtonClicked,
				false);
		this.setEnableArrowButton(".btn_nxt", onNextProductImageButtonClicked,
				false);
		...
		setTimeout(function() {
			this.setEnableArrowButton(".btn_prev",
					onPrevProductImageButtonClicked, true);
			this.setEnableArrowButton(".btn_nxt",
					onNextProductImageButtonClicked, true);
		}.bind(this), 1000);
