...
var ProductImage = 
{
	...
	animate : function (children, childrenLength, direction) {
		...
		this.setEnableArrowButton(".btn_prev", onPrevProductImageButtonClicked, false);
		this.setEnableArrowButton(".btn_nxt", onNextProductImageButtonClicked, false);
		...
		setTimeout(function(){
			this.setEnableArrowButton(".btn_prev", onPrevProductImageButtonClicked, true);
			this.setEnableArrowButton(".btn_nxt", onNextProductImageButtonClicked, true);
		}.bind(this),1000);
		
	},

	//이미지 슬라이드 영역에 있는 화살표 버튼을 비활성화 또는 활성화하는 함수
	setEnableArrowButton : function (anchorSelector, onclick, isEnabled){
...
var Comment = 
{
	...
	addComments: function (comments, showLess){
		...
		Handlebars.registerHelper("thumb_area_date", function(reservationDate){
			...
			//Internet Explorer 호환을 위해 날짜형식을 '2019-07-28 13:58:16.0'에서 '2019-07-28'로 변경
