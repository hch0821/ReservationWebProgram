...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/reserv/res/css/style.css">
	<link rel="stylesheet" type="text/css" href="/reserv/res/css/main.css">
</head>
...
<body>
    ...
    <li id="promotionList" class="item" style="background-image: url({productImageUrl});">
        <div> <span class="img_btm_border"></span> <span class="img_right_border"></span> <span class="img_bg_gra"></span>
            <div class="event_txt">
	...
	<!--탭 눌렀을때 나타나는 미리보기 아이템 템플릿-->
	<script type="rv-template" id="itemList">
        <li class="item">
            <a href="/reserv/detail?displayInfoId={displayInfoId}" class="item_book">
                <div class="item_preview">
                    <img alt="{productDescription}" class="img_thumb" src="/reserv/api/productImages/{productId}?type=th">
	...
	<!-- 탭에 들어갈 아이템 템플릿 -->
	<script type="rv-template" id="tabitem">
        <li class="item {id}">
            <a class="anchor" href="javascript:void(0);"><span>{name}</span></a>
        </li> 
    </script>

	<script type="text/javascript" src='/reserv/res/js/main.js'></script>
</body>
