...
<body>
		...
		<div class="header">
			<header class="header_tit">
				...
				<c:if test="${sessionScope.reservationEmail != null}">
					<a href="/reserv/checkSession" class="btn_my"> <span class="viewReservation"
							title="예약확인">${sessionScope.reservationEmail}</span> </a>
				...
				<div class="my_summary">
					<ul class="summary_board">
						<li class="item">
							...
							<a href="javascript:void(0);" class="link_summary_board on"> <i class="spr_book2 ico_book2"></i> <em
									class="tit">전체</em> <span class="figure">6</span> </a>
						</li>
						<li class="item">
							<a href="javascript:void(0);" class="link_summary_board"> <i class="spr_book2 ico_book_ss"></i> <em
									class="tit">이용예정</em> <span class="figure">2</span> </a>
						</li>
						<li class="item">
							<a href="javascript:void(0);" class="link_summary_board"> <i class="spr_book2 ico_check"></i> <em
									class="tit">이용완료</em> <span class="figure">2</span> </a>
						</li>
						<li class="item">
							<a href="javascript:void(0);" class="link_summary_board"> <i class="spr_book2 ico_back"></i> <em
									...
									<div class="card_body">
										...
										<div class="middle">
											<div class="card_detail">
												...
												<div class="booking_cancel">
													<a href="./reviewWrite.html"><button class="btn"><span>예매자 리뷰
																남기기</span></button></a>
												</div>
											</div>
										</div>
	...
	<script type="text/javascript" src='/reserv/res/js/myreservation.js'></script>
</body>
