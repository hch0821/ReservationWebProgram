    ...
    <div id="container">
        ...
        <div class="header fade">
            <header class="header_tit">
                <h1 class="logo">
                    <a href="/reserv/" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span>
                    </a>
                                ...
                                <div class="inline_form"> <label class="label" for="tel"> <span
                                    ...
                                    <div class="inline_control tel_wrap">
                                        <input type="tel" name="tel" id="tel" class="tel" value=""
                                            placeholder="휴대폰 번호 입력 시 예매내역 문자발송">
    ...
    <script type="rv-template" id="ticket_info_template">
        <div class="qty">
            <div class="count_control">
                ...
                <div class="individual_price"><span class="total_price">0</span><span
                        class="price_type">원</span></div>
            </div>
            <div class="qty_info_icon"> <strong class="product_amount"> <span>{{#lookupPriceType priceTypeName}}{{priceType}}{{/lookupPriceType}}</span> </strong>
                <strong class="product_price"> <span class="price">{{#price_times_discountRate1 price discountRate}}{{price}}{{/price_times_discountRate1}}</span>  </strong> 
                <em class="product_dsc">{{#price_times_discountRate2 price discountRate}}{{price}}{{/price_times_discountRate2}} </em> 
            </div>
        </div>
