...
<body>
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area"> <span class="graph_mask"> <em class="graph_value"
                                        style="width: 0%;"></em> </span> <strong class="text_value"> <span>0</span> <em
                                        class="total">5.0</em> </strong> <span class="join_count"><em
    ...
    <script type="text/javascript" src='/reserv/res/js/review.js'></script>
</body>
